...
class NotificationSuggestionAdapter: ListAdapter<Notification, NotificationSuggestionAdapter.NotificationSuggestionViewHolder>(NotificationItemDiffCallback())  {
