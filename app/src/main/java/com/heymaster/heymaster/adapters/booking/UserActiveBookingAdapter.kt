...
import com.heymaster.heymaster.adapters.booking.UserActiveBookingAdapter.ActiveBookingViewHolder
import com.heymaster.heymaster.databinding.ItemActiveBookingBinding
import com.heymaster.heymaster.model.Service

class UserActiveBookingAdapter: ListAdapter<Service,ActiveBookingViewHolder>(ItemActiveBookingDiffCallBack()) {
