package com.heymaster.heymaster.adapters.details
...
class DetailsPortfolioAdapter :ListAdapter<Portfolio, DetailsPortfolioAdapter.DetailsPortfolioViewHolder>(DetailsPortfolioItemDifCallBack()) {
