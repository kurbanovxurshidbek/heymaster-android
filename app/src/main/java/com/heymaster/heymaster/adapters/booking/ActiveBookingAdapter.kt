...
class ActiveBookingAdapter(private val list: ArrayList<UActiveBookingM>, var context: Context) :
    ListAdapter<UActiveBookingM, ActiveBookingVH>(ItemActiveBookingDiffCallBack()) {
